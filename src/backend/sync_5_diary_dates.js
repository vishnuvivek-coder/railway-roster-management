...
const DATES_CONFIG = [
  ...
  // =========================================================================
  // DATE 4: 06.09.26 SUNDAY (Pages 180 & 181)
  // =========================================================================
  {
    date: '2026-09-06',
  ...
  // =========================================================================
  // DATE 5: 07.09.26 MONDAY (Pages 182 & 183)
  // =========================================================================
  {
    date: '2026-09-07',
...
async function syncAll() {
  console.log('Starting sync for 5 Diary Dates: 01.09, 02.09, 03.09, 06.09, 07.09...');
  ...
  console.log('\n========================================\nALL 5 DATES SYNCHRONIZED SUCCESSFULLY!\n========================================');
  db.close();
}
