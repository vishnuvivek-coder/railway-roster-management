...
async function initDb() {
  ...
  if (catCount.count === 0) {
    ...
    const corLinks = [
      ...
      { num: 4, trains: '17261', from: 'GNT', to: 'TPTY', coaches: 'AC', rest: 0, set_name: 'GNT-TPTY Exp', set_type: '2-Day Set' },
      { num: 5, trains: '12733', from: 'TPTY', to: 'GNT', coaches: 'AC', rest: 0, set_name: 'Narayanadri Exp', set_type: '2-Day Set' },
      { num: 6, trains: 'REST', from: '', to: '', coaches: '', rest: 1, set_name: 'HQ Rest', set_type: 'Other / REST' },
      { num: 7, trains: 'REST', from: '', to: '', coaches: '', rest: 1, set_name: 'Weekly Rest 1', set_type: 'Other / REST' },
      { num: 8, trains: '20629', from: 'GNT', to: 'TPTY', coaches: 'AC', rest: 0, set_name: 'Vande Bharat Exp (20629/30)', set_type: '2-Day Set' },
      { num: 9, trains: '20630', from: 'TPTY', to: 'GNT', coaches: 'AC', rest: 0, set_name: 'Vande Bharat Exp (20629/30)', set_type: '2-Day Set' },
      { num: 10, trains: '12734', from: 'GNT', to: 'TPTY', coaches: 'AC', rest: 0, set_name: 'Narayanadri / VB (COR-2)', set_type: '2-Day Set' },
      { num: 11, trains: '20630', from: 'TPTY', to: 'GNT', coaches: 'AC', rest: 0, set_name: 'Narayanadri / VB (COR-2)', set_type: '2-Day Set' },
      { num: 12, trains: '12604', from: 'GNT', to: 'MAS', coaches: 'AC', rest: 0, set_name: 'Chennai Exp (12604/03)', set_type: '2-Day Set' },
      { num: 13, trains: '12603', from: 'MAS', to: 'GNT', coaches: 'AC', rest: 0, set_name: 'Chennai Exp (12604/03)', set_type: '2-Day Set' },
      ...
      { num: 18, trains: '12734', from: 'GNT', to: 'TPTY', coaches: 'AC', rest: 0, set_name: 'Narayanadri / 17262 (COR-1)', set_type: '2-Day Set' },
      { num: 19, trains: '17262', from: 'TPTY', to: 'GNT', coaches: 'AC', rest: 0, set_name: 'Narayanadri / 17262 (COR-1)', set_type: '2-Day Set' },
      { num: 20, trains: 'REST', from: '', to: '', coaches: '', rest: 1, set_name: 'HQ Rest', set_type: 'Other / REST' },
